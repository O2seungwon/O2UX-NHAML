/*amd /WebContent/cm/gcc/win.xml 49655 3e9088866e2b38d7ea43dab5bdd2ce9866dc0a15ea771d54d6acfbfe880ef9ca */
...
scwin.openPopup = function (url, opts, data) {
  return new Promise(function (resolve, reject) {
    ...
    scwin._openPopup(url, opts, data, closeActionFunc);
  });
};
 ...
 * @example
 */
scwin._openPopup = function (url, opt, data, closeActionFunc) {
  data.menuInfo = {
    src: url
  };
  const _dataObj = {
...
scwin.closePopup = function (callbackParam, callbackFnStr) {
  ...
  scwin._closePopup($c.win.getPopupId($p), $c.str.serialize($p, callbackParam), callbackFnStr);
};
 ...
 */
scwin.messageBox = function (messageType, messageStr, closeCallbackFncName, opts) {
 ...
 */
scwin.setPageFrameSrc = function (pageFrameObj, moveUrl, paramObj) {
  paramObj = {
    "dataObject": {
      "type": "json",
      "name": "paramData",
