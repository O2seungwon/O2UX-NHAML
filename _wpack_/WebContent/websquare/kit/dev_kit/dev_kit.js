/*amd /WebContent/websquare/kit/dev_kit/dev_kit.xml 20038 0e93aa66e887115fe09b98ea8e7dcfff0956e90b51d176e866e23d069826cdd5 */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:7,N:'xml-stylesheet',instruction:'href="/websquare/kit/dev_kit/dev_kit.css" type="text/css"'},{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',E:[{T:1,N:'w2:type',E:[{T:3,text:'DEFAULT'}]},{T:1,N:'w2:buildDate'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'},E:[{T:1,N:'w2:dataList',A:{baseNode:'list',repeatNode:'map',id:'resource',saveRemovedData:'true'},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{id:'id',name:'id',dataType:'text'}},{T:1,N:'w2:column',A:{id:'category',name:'category',dataType:'text'}},{T:1,N:'w2:column',A:{id:'title',name:'타이틀',dataType:'text'}},{T:1,N:'w2:column',A:{id:'iconSrc',name:'아이콘자원',dataType:'text'}},{T:1,N:'w2:column',A:{id:'previewSrc',name:'미리보기자원',dataType:'text'}},{T:1,N:'w2:column',A:{id:'xmlpath',name:'xml자원',dataType:'text'}},{T:1,N:'w2:column',A:{id:'favMenu',name:'즐겨찾기',dataType:'text'}}]},{T:1,N:'w2:data',E:[{T:1,N:'w2:row'}]}]},{T:1,N:'w2:dataList',A:{baseNode:'list',repeatNode:'map',id:'category',saveRemovedData:'true'},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{id:'id',name:'name1',dataType:'text'}},{T:1,N:'w2:column',A:{id:'iconSrc',name:'name2',dataType:'text'}},{T:1,N:'w2:column',A:{id:'path',name:'name3',dataType:'text'}}]}]}]},{T:1,N:'w2:workflowCollection'}]},{T:1,N:'script',A:{type:'text/javascript',src:'/websquare/kit/dev_kit/studioAPI.js'}},{T:1,N:'script',A:{type:'text/javascript',lazy:'false'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){scwin.initUserDataTop = true;
