/*amd /WebContent/websquare/kit/design_kit/design_kit.xml 20047 8a88fd73979dc33d29e8a0adf8aa658eda9f5bd27b0837e984390baf98f1f51c */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:7,N:'xml-stylesheet',instruction:'href="/websquare/kit/design_kit/design_kit.css" type="text/css"'},{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',E:[{T:1,N:'w2:type',E:[{T:3,text:'DEFAULT'}]},{T:1,N:'w2:buildDate'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'},E:[{T:1,N:'w2:dataList',A:{baseNode:'list',repeatNode:'map',id:'resource',saveRemovedData:'true'},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{id:'id',name:'id',dataType:'text'}},{T:1,N:'w2:column',A:{id:'category',name:'category',dataType:'text'}},{T:1,N:'w2:column',A:{id:'title',name:'타이틀',dataType:'text'}},{T:1,N:'w2:column',A:{id:'iconSrc',name:'아이콘자원',dataType:'text'}},{T:1,N:'w2:column',A:{id:'previewSrc',name:'미리보기자원',dataType:'text'}},{T:1,N:'w2:column',A:{id:'xmlpath',name:'xml자원',dataType:'text'}},{T:1,N:'w2:column',A:{id:'favMenu',name:'즐겨찾기',dataType:'text'}}]},{T:1,N:'w2:data',E:[{T:1,N:'w2:row'}]}]},{T:1,N:'w2:dataList',A:{baseNode:'list',repeatNode:'map',id:'category',saveRemovedData:'true'},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{id:'id',name:'name1',dataType:'text'}},{T:1,N:'w2:column',A:{id:'iconSrc',name:'name2',dataType:'text'}},{T:1,N:'w2:column',A:{id:'path',name:'name3',dataType:'text'}}]}]}]},{T:1,N:'w2:workflowCollection'}]},{T:1,N:'script',A:{type:'text/javascript',src:'/websquare/kit/design_kit/studioAPI.js'}},{T:1,N:'script',A:{type:'text/javascript',lazy:'false'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){scwin.initUserDataTop = true;
...
fnScrollTo = function (id) {
  ...
  if (id == scwin.favCategoryMenu) {
    //즐겨찾기 메뉴일 경우 즐겨찾기 항목이 없을 경우 아무것도 하지 않기.
...
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload','ev:onpageunload':'scwin.onpageunload',style:''},E:[{T:1,N:'xf:group',A:{id:'layout',class:'designKit_layout',style:''},E:[{T:1,N:'xf:group',A:{class:'designKit_search',id:'',style:''},E:[{T:1,N:'w2:autoComplete',A:{editType:'select',id:'atc_search',useKeywordHighlight:'false',style:'width: 178px;height: 21px;',submenuSize:'auto',search:'contain',autoFocus:'false',allowEmptySubmission:'false',emptyItem:'true',emptyIndex:'1',noResult:'useData','ev:onviewchange':'scwin.atc_search_onviewchange',allOption:'',chooseOption:'',ref:'',placeholder:'Search...'},E:[{T:1,N:'w2:choices',E:[{T:1,N:'w2:item',E:[{T:1,N:'w2:label',E:[{T:4,cdata:'전체'}]},{T:1,N:'w2:value'}]}]}]}]},{T:1,N:'xf:group',A:{style:'',id:'',class:'designKit_side'},E:[{T:1,N:'xf:group',A:{style:'',id:'',class:'designKit_menu'},E:[{T:1,N:'w2:generator',A:{id:'categoryMenuGen',style:'',tagname:'ul'},E:[{T:1,N:'xf:group',A:{id:'li_category',style:'',tagname:'li',class:'li_categoryMenuGen'},E:[{T:1,N:'xf:group',A:{id:'',tagname:'a'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:href',E:[{T:3,text:'#mf_layout'}]}]},{T:1,N:'xf:image',A:{id:'categoryMenuIcon',src:'/cm/template/snippets/00_화면시작/00_화면시작.png',style:''}}]},{T:1,N:'w2:anchor',A:{class:'designKit_m_tit',href:'#mf_layout',id:'categoryMenu',outerDiv:'false',style:''},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'화면시작'}]}]}]}]}]}]},{T:1,N:'w2:generator',A:{style:'',id:'categoryGen',class:'designKit_cont'},E:[{T:1,N:'xf:group',A:{class:'designKit_dfbox',id:'categoryTitleGrp',style:''},E:[{T:1,N:'w2:textbox',A:{class:'designKit_df_tit',id:'categoryTitle',label:'화면시작',style:''}}]},{T:1,N:'w2:generator',A:{class:'designKit_list',id:'resourceListGen',style:'',tagname:'ul'},E:[{T:1,N:'xf:group',A:{class:'item',id:'',style:'',tagname:'li'},E:[{T:1,N:'xf:group',A:{class:'img_box',id:''},E:[{T:1,N:'xf:image',A:{id:'resourceIcon',src:'/cm/template/snippets/00_화면시작/0_01%20페이지시작_icon.png',style:'',tabIndex:'','ev:onclick':'scwin.resourceIcon_onclick'}},{T:1,N:'xf:input',A:{adjustMaxLength:'false',id:'resourceId',style:'width: 144px;height: 21px;',type:'hidden'}},{T:1,N:'xf:input',A:{adjustMaxLength:'false',id:'resourceCategory',style:'width: 144px;height: 21px;',type:'hidden'}},{T:1,N:'xf:input',A:{adjustMaxLength:'false',id:'resourcePreviewSrc',style:'width: 144px;height: 21px;',type:'hidden'}},{T:1,N:'xf:input',A:{adjustMaxLength:'false',id:'resourceXmlpath',style:'width: 144px;height: 21px;',type:'hidden'}},{T:1,N:'xf:input',A:{adjustMaxLength:'false',id:'resourceIconSrc',style:'width: 144px;height: 21px;',type:'hidden'}},{T:1,N:'xf:group',A:{class:'sc_area',id:'',style:''},E:[{T:1,N:'w2:anchor',A:{class:'btn_snippet',id:'btn_popup',outerDiv:'false',style:'','ev:onclick':'scwin.btn_popup_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'미리보기'}]}]}]}]},{T:1,N:'xf:group',A:{id:'',class:'title_box'},E:[{T:1,N:'w2:anchor',A:{outerDiv:'false',style:'',id:'btn_favorit',class:'btn_snp_favorit','ev:onclick':'scwin.btn_favorit_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'즐겨찾기'}]}]},{T:1,N:'w2:anchor',A:{outerDiv:'false',style:'',id:'resourceTitle','ev:onclick':'scwin.resourceIcon_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'01_페이지시작_icon'}]}]}]}]}]}]},{T:1,N:'xf:group',A:{style:'display: none',id:'',class:'designKit_cont'},E:[{T:1,N:'xf:group',A:{style:'',id:'',class:'designKit_dfbox'},E:[{T:1,N:'w2:textbox',A:{style:'',id:'',label:'화면시작',class:'designKit_df_tit'}}]},{T:1,N:'w2:generator',A:{style:'',id:'',class:'designKit_list',tagname:'ul'},E:[{T:1,N:'xf:group',A:{class:'item',id:'',tagname:'li',style:''},E:[{T:1,N:'xf:group',A:{class:'img_box',id:''},E:[{T:1,N:'xf:image',A:{id:'',src:'/cm/template/snippets/00_화면시작/01_페이지시작_icon.png',style:'',tabIndex:''}},{T:1,N:'xf:group',A:{class:'sc_area',id:'',style:''},E:[{T:1,N:'w2:anchor',A:{class:'btn_snippet',id:'',outerDiv:'false',style:''},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'미리보기'}]}]},{T:1,N:'w2:anchor',A:{class:'btn_snp_favorit',id:'',outerDiv:'false',style:''},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'즐겨찾기'}]}]}]}]},{T:1,N:'w2:anchor',A:{id:'',outerDiv:'false',style:''},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'01_페이지시작_icon'}]}]}]}]}]},{T:1,N:'xf:group',A:{id:'',class:'designKit_zoom_box'},E:[{T:1,N:'xf:group',A:{style:'',id:'',class:'designKit_zoom_comp'},E:[{T:1,N:'w2:wframe',A:{style:'',id:'wf_preview'}},{T:1,N:'w2:anchor',A:{ref:'',outerDiv:'false',style:'',id:'',class:'btn_zoom_close'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'Insert Text'}]}]}]}]},{T:1,N:'xf:group',A:{style:'',id:'',class:'designKit_dim'}}]}]}]}]})